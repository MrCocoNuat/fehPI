...
export function toFileTitle(name: string, extension: string){
    // The FEH mediawiki stores all files with names exclusively in ASCII, so some manual transliterations are needed 
    Object.entries(transliteration).forEach(([before, after]) => name.replaceAll(before, after));

    // some additional special characters too
    name.replaceAll(" ", "_").replaceAll(":","").replaceAll("/","_").replaceAll("'","").replaceAll(`"`,``);
    return name+extension;
}

export const TITLE_SEPARATOR = "|";
// don't ask me why these are different...
export const HERO_IMAGE_EXTENSION = ".webp";
export const SKILL_IMAGE_EXTENSION = ".png";